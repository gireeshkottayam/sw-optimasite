...
define('OPTIMASITE_VERSION', '1.1.1');
...
require_once OPTIMASITE_DIR . 'includes/class-optimasite-guard.php';
...
register_activation_hook(__FILE__, array('OptimaSite_Guard', 'activate_schedule'));
register_deactivation_hook(__FILE__, array('OptimaSite_Guard', 'deactivate_schedule'));

add_action('plugins_loaded', array('OptimaSite_License', 'init'), 5);
add_action('plugins_loaded', array('OptimaSite_Guard', 'init'), 5);
